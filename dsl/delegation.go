...
func BuildTeamPrompt(system string, team []string, agentDescriptions map[string]string, blackboardEnabled bool) string {
	...
	teamSection += "\nPost progress updates to your team channel using `post_to_channel` as you work — what you're doing, what just finished, what's next."
	teamSection += "\nThe user watches channels to follow your team's progress. Don't wait until everything is done — share as you go, like thinking out loud in a war room."
